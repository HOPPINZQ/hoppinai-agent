        ...
        {LAYERS.map((layer, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-3 px-6 py-4">
                ...
                <div>
                  <h2 className="text-xl font-bold text-zinc-100">
                    <span className="text-zinc-600">L{index + 1}</span>
                    {" "}
                    {layer.label}
                  </h2>
              ...
              <div className="border-t border-white/[0.04] bg-white/[0.02] px-6 py-4">
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
                  {versionInfos.map(({ id, info, meta }) => {
                    const isUnimplemented = UNIMPLEMENTED_VERSIONS.has(id);

                    return isUnimplemented ? (
                      <div key={id} className="group opacity-50 cursor-not-allowed">
