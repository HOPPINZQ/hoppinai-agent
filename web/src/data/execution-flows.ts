...
export const EXECUTION_FLOWS: Record<string, FlowDefinition> = {
  s01: {
    nodes: [
      ...
      { id: "bash", label: "执行 Bash 命令", type: "subprocess", x: COL_LEFT, y: 280 },
    ...
    edges: [
      ...
      { from: "tool_check", to: "bash", label: "是" },
      { from: "tool_check", to: "end", label: "否" },
      { from: "bash", to: "append" },
      { from: "append", to: "llm" },
    ],
  },
  s02: {
    nodes: [
      ...
      { id: "llm", label: "LLM 调用", type: "process", x: COL_CENTER, y: 110 },
      { id: "tool_check", label: "tool_use?", type: "decision", x: COL_CENTER, y: 190 },
      { id: "dispatch", label: "工具调度", type: "process", x: COL_LEFT, y: 280 },
      { id: "exec", label: "执行 Bash 命令 / 读取 / 写入 / 编辑", type: "subprocess", x: COL_LEFT, y: 360 },
    ...
    edges: [
      { from: "start", to: "llm" },
      { from: "llm", to: "tool_check" },
      { from: "tool_check", to: "dispatch", label: "是" },
      { from: "tool_check", to: "end", label: "否" },
  ...
  s03: {
    nodes: [
      { id: "start", label: "用户输入", type: "start", x: COL_CENTER, y: 30 },
      { id: "todo", label: "创建任务", type: "process", x: COL_CENTER, y: 100 },
    ...
    edges: [
      ...
      { from: "todo", to: "llm" },
      { from: "llm", to: "tool_check" },
      { from: "tool_check", to: "exec", label: "是" },
      { from: "tool_check", to: "end", label: "否" },
      { from: "exec", to: "append" },
      { from: "append", to: "llm" },
    ],
  ...
  s04: {
    ...
    edges: [
      { from: "start", to: "llm" },
      { from: "llm", to: "tool_check" },
      { from: "tool_check", to: "is_task", label: "是" },
      { from: "tool_check", to: "end", label: "否" },
      { from: "is_task", to: "spawn", label: "任务" },
      { from: "is_task", to: "exec", label: "其他" },
  ...
  s05: {
    ...
    edges: [
      { from: "start", to: "llm" },
      { from: "llm", to: "tool_check" },
      { from: "tool_check", to: "is_skill", label: "是" },
      { from: "tool_check", to: "end", label: "否" },
      { from: "is_skill", to: "load", label: "技能" },
      { from: "is_skill", to: "exec", label: "其他" },
      { from: "load", to: "inject" },
  ...
  s06: {
    nodes: [
      { id: "start", label: "用户输入", type: "start", x: COL_CENTER, y: 30 },
      { id: "compress_check", label: "超过 token 限制?", type: "decision", x: COL_CENTER, y: 110 },
  ...
  s12: {
    nodes: [
      ...
      { id: "llm", label: "LLM 调用", type: "process", x: COL_CENTER, y: 110 },
      { id: "tool_check", label: "tool_use?", type: "decision", x: COL_CENTER, y: 190 },
      { id: "is_wt", label: "工作树工具?", type: "decision", x: COL_LEFT, y: 280 },
