...
const STEP_INFO: StepInfo[] = [
  {
    title: "文件化任务",
    description:
      "任务以 JSON 文件存储在磁盘上；与内存状态不同，它们能跨上下文压缩存活。",
  },
  {
    title: "启动 T1",
    description:
      "没有依赖的任务可以立即开始。T1 没有阻塞。",
  },
  {
    title: "T1 完成",
    description: "完成 T1 会解除对它的依赖：T2 与 T3。",
  },
  {
    title: "并行工作",
    description:
      "T2 与 T3 互不依赖，因此可以同时进行。",
  },
  {
    title: "部分解锁",
    description:
      "T4 同时依赖 T2 与 T3；它会等待所有阻塞完成。",
  },
  {
    title: "完全解锁",
    description: "所有阻塞解除，T4 现在可以继续。",
  },
  {
    title: "图谱收敛",
    description:
      "整个依赖图被解决；文件化持久化意味着它能跨上下文压缩正常运行。",
  },
];
