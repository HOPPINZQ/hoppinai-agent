...
const STEPS: StepState[] = [
  {
    title: "单工作区的痛点",
    desc: "两个任务同时进行，但修改都会落到同一目录里，必然发生冲突。",
    op: "task_create x2",
    tasks: [
  ...
  {
    title: "为任务 1 分配通道",
    desc: "创建 worktree 通道并与任务 1 关联，明确归属。",
  ...
  {
    title: "为任务 2 分配通道",
    desc: "通道创建与任务绑定可以分开；这里任务 2 在创建通道后再绑定。",
  ...
  {
    title: "保留一个通道，关闭另一个",
    desc: "收尾可混合决策：保留 ui-login 以便后续，移除 auth-refactor 并完成任务 1。",
  ...
  {
    title: "隔离 + 协调 + 事件",
    desc: "任务板记录共享真相，worktree 通道隔离执行，事件提供可审计的旁路轨迹。",
