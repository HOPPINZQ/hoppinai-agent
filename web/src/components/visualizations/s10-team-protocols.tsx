...
const SHUTDOWN_STEPS = [
  { title: "结构化协议", desc: "协议定义带关联 request_id 的结构化消息交换。" },
  { title: "关停请求", desc: "组长发起关停。request_id 将请求与响应关联。" },
  { title: "队友决策", desc: "队友可以接受或拒绝；这不是强制 kill——而是礼貌的请求。" },
  { title: "已批准", desc: "响应携带相同 request_id，队友干净退出。" },
];

// -- Plan approval protocol step definitions --
const PLAN_STEPS = [
  { title: "计划审批", desc: "处于 plan_mode 的队友在实施变更前必须获得批准。" },
  { title: "提交计划", desc: "队友设计计划并发送给组长审阅。" },
  { title: "组长审阅", desc: "组长审阅并批准，或带反馈地拒绝；相同的请求-响应模式。" },
];
