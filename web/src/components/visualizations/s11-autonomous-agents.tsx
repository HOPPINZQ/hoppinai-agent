...
// -- Step definitions --
const STEPS = [
  { title: "自组织智能体", desc: "自主智能体不需要协调者，通过 idle-poll-claim-work 循环自我治理。" },
  { title: "空闲计时器", desc: "每个空闲智能体计数轮次；超时会触发自主轮询任务。" },
  { title: "轮询任务板", desc: "超时！智能体读取任务板，寻找未认领工作。" },
  { title: "认领任务", desc: "智能体把自己的名字写入任务记录：原子操作，无冲突。" },
  { title: "执行任务", desc: "智能体在认领的任务上工作，使用自己的 agent loop。" },
  { title: "独立轮询", desc: "多个智能体独立轮询与认领，无需中心协调。" },
  { title: "完成并重置", desc: "任务完成。智能体回到 idle，循环继续。" },
  { title: "涌现式组织", desc: "三个智能体，零协调开销。轮询 + 超时 = 组织涌现。" },
];
