...
public class Csqaqervice {
            ...
            try {
                ...
                if (retryCount < maxRetries) {
                    try {
                        ...
                        CsqaqError error = mapper.readValue(errorBody, CsqaqError.class);
                    ...
                    if (e.response() != null && e.response().errorBody() != null) {
                        try {
                            ...
                            throw new CsqaqException(error, e, e.code());
    ...
    public static CsqaqApi buildApi(String cookie, Duration timeout) {
        ObjectMapper mapper = defaultObjectMapper();
        OkHttpClient client = defaultClient(cookie, timeout);
        Retrofit retrofit = defaultRetrofit(client, mapper);

        return retrofit.create(CsqaqApi.class);
    }
